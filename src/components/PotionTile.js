...
function PotionTile({ potion, clickAction, children, type }) {
  const inInventory = type === "inventory"
  
  return (
    <div className={ inInventory ? "inventory-card" : "card"}>
      <div 
        onClick={() => { clickAction(potion.id) }} 
